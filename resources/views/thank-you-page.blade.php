...
<head>
    ...
    <script>
        ...
        fbq('init', '629756688145300');
        fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
                   src="https://www.facebook.com/tr?id=629756688145300&ev=PageView&noscript=1"
        /></noscript>
                ...
                <!-- progressbar -->
                    ...
                    <fieldset>
                        <div class="form-card">
                            ...
                            <img src="{{ asset('times-' . app()->getLocale() . '.jpg') }}" style="width: 100%;" alt="Times">
